...
print(d)
d1 = pd.read_csv('D:\All_Script\Python_Radarbox/Radarbox_UAM_clean1_f1.csv', usecols=['image'])
print(d1)
...
for i in d['trace1']:   #d【‘trace1’】：取trace1这一列中的每个元素
    try:
       ...
       # b = i.split ( "/" )[5]
       print(i)
       driver.get_screenshot_as_file ( 'D:\All_Script\Python_Radarbox\Image_UAM/'+ name[a] )
       a=a+1
       print(a)
    except:
        print('无图像')
