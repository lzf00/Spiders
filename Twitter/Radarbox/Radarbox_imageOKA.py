...
d = pd.read_csv('D:\All_Script\Python_Radarbox/Radarbox_OKA_clean1_f1.csv', usecols=['trace1'])#pandas读文件某一列
print(d)
d1 = pd.read_csv('D:\All_Script\Python_Radarbox/Radarbox_OKA_clean1_f1.csv', usecols=['image'])
print(d1)
...
for i in d['trace1']:   #d【‘trace1’】：取trace1这一列中的每个元素
    try:
       ...
       driver.get_screenshot_as_file ( 'D:\All_Script\Python_Radarbox\Image_OKA/'+ name[a] )
       a=a+1
       print(a)
       print('----------------------------------')
    except:
