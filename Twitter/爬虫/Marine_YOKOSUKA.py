...
url='https://www.marinetraffic.com/en/data/?asset_type=arrivals_departures&columns=shipname,move_type,port_type,port_name,ata_atd,mmsi,imo,origin_port_atd,ship_type,dwt,fleet&port_in|begins|YOKOSUKA|port_in=18413'
driver.get(url)
