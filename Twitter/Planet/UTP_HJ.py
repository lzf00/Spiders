...
import pyautogui
key = 'UTP'
file_path = 'D:\All_Script\Python_planet_picture\\UTP2.28/' + key + '.csv'
...
for date in all_date:
    try:
        ...
        print ( text1 )
        pyautogui.screenshot( 'D:\All_Script\Python_planet_picture\\UTP2.28/' + key + '_' + text1 + '.png' ,region=(1080, 197, 646, 646))#顶点位置，图片尺寸
        ...
        time.sleep(1)
        pyautogui.scroll (  490, x, y, _pause=1 )

        time.sleep ( 8 )
        #pyautogui.screenshot( 'D:\All_Script\Python_planet_picture\\UTP/' + key + '_' + text1 +'_T'+ '.png' ,region=(720, 325, 1021, 690))
        pyautogui.screenshot( 'D:\All_Script\Python_planet_picture\\UTP2.28/' + key + '_' + text1 +'_T'+ '.png' ,region=(609, 197, 1093, 835))
        #driver.find_element_by_xpath ('//button[@class="MuiButtonBase-root MuiFab-root MuiSpeedDialAction-fab jss334 jss342 MuiFab-sizeSmall"]' ).click ()#点击放大按钮
        print ( '已截图222' )
        pyautogui.scroll ( -490, x, y, _pause=1 )
        time.sleep(1)
