...
import pyautogui
key = 'HIN'
file_path = 'D:\All_Script\Python_planet_picture\\HIN/' + key + '1.csv'
...
for date in all_date:
    try:
        ...
        time.sleep ( 10 )
        print ( "11111" )#测试代码
        data = driver.find_element_by_xpath ('//div[@class="MuiButtonBase-root MuiListItem-root jss1654 MuiListItem-gutters MuiListItem-divider MuiListItem-button MuiListItem-secondaryAction Mui-selected jss1655"]/div[2]/div[1]/h6' )
        # 显示图片时间
        print ( "22222" )
        ...
        print ( text1 )
        time.sleep(2)
        pyautogui.screenshot( 'D:\All_Script\Python_planet_picture\\HIN/' + key + '_' + text1 + '.png' ,region=(1126, 171, 646, 646))#顶点位置，图片尺寸
        ...
        time.sleep(1)
        pyautogui.scroll (  240, x, y, _pause=1 )
        time.sleep ( 7 )
        #pyautogui.screenshot( 'D:\All_Script\Python_planet_picture\\UTP/' + key + '_' + text1 +'_T'+ '.png' ,region=(720, 325, 1021, 690))
        pyautogui.screenshot( 'D:\All_Script\Python_planet_picture\\HIN/' + key + '_' + text1 +'_T'+ '.png' ,region=(485, 152, 1256, 890))
        #driver.find_element_by_xpath ('//button[@class="MuiButtonBase-root MuiFab-root MuiSpeedDialAction-fab jss334 jss342 MuiFab-sizeSmall"]' ).click ()#点击放大按钮
        print ( '已截图222' )
        pyautogui.scroll ( -240, x, y, _pause=1 )
        time.sleep(1)
