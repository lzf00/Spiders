...
import pyautogui
key = 'UAM'
file_path = 'D:\All_Script\Python_planet_picture\\UAM2.27/' + key + '.csv'
...
for date in all_date:
    try:
            ...
            time.sleep ( 4 )
            print ( "11111" )#测试代码
            data = driver.find_element_by_xpath ('//div[@class="MuiButtonBase-root MuiListItem-root jss1611 MuiListItem-gutters MuiListItem-divider MuiListItem-button MuiListItem-secondaryAction Mui-selected jss1612"]/div[2]/div[1]/h6' )
            # 显示图片时间
            ...
            time.sleep(3)
            pyautogui.screenshot ( 'D:\All_Script\Python_planet_picture\\UAM2.27/' + key + '_' + text1 + '.png',region=(873, 192, 650, 650) )
            ...
            time.sleep(1)
            pyautogui.scroll (  110, x, y, _pause=1 )
            time.sleep ( 4 )
            pyautogui.screenshot( 'D:\All_Script\Python_planet_picture\\UAM2.27/' + key + '_' + text1 +'_T'+ '.png' ,region=(607, 184, 1094, 850))
