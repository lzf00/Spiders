...
import pyautogui
key = 'UTP'
file_path = 'D:\All_Script\Python_planet_picture\\UTP/' + key + '1.csv'
...
for date in all_date:
    try:
        time.sleep(1)
        date.find_element_by_xpath ('./div[@class="MuiAvatar-root MuiAvatar-circle jss1164 MuiAvatar-colorDefault"]' ).click ()#图片下的日期按钮
        time.sleep ( 8 )
        print ( "11111" )#测试代码
        data = driver.find_element_by_xpath ('//div[@class="MuiButtonBase-root MuiListItem-root jss1659 MuiListItem-gutters MuiListItem-divider MuiListItem-button MuiListItem-secondaryAction Mui-selected jss1660"]/div[2]/div[1]/h6' )
        # 显示图片时间
        print ( "22222" )
        ...
        print ( text1 )
        pyautogui.screenshot( 'D:\All_Script\Python_planet_picture\\UTP/' + key + '_' + text1 + '.png' ,region=(1126, 171, 646, 646))#顶点位置，图片尺寸
        ...
        time.sleep(1)
        pyautogui.scroll (  290, x, y, _pause=1 )
