...
import pyautogui
key = 'DNA'
file_path = 'D:\All_Script\Python_planet_picture\\DNA2.28/' + key + '.csv'
...
for date in all_date:
    try:
        ...
        time.sleep ( 8 )
        print ( "11111" )#测试代码
        data = driver.find_element_by_xpath ('//div[@class="MuiButtonBase-root MuiListItem-root jss1703 MuiListItem-gutters MuiListItem-divider MuiListItem-button MuiListItem-secondaryAction Mui-selected jss1704"]/div[2]/div[1]/h6' )
        # 显示图片时间
        ...
        print ( text1 )
        time.sleep(2)
        pyautogui.screenshot( 'D:\All_Script\Python_planet_picture\\DNA2.28/' + key + '_' + text1 + '.png' ,region=(1080, 197, 646, 646))#顶点位置，图片尺寸
        ...
        pyautogui.screenshot( 'D:\All_Script\Python_planet_picture\\DNA2.28/' + key + '_' + text1 +'_T'+ '.png' ,region=(607, 198, 1093, 835))
        #driver.find_element_by_xpath ('//button[@class="MuiButtonBase-root MuiFab-root MuiSpeedDialAction-fab jss334 jss342 MuiFab-sizeSmall"]' ).click ()#点击放大按钮
        print ( '已截图222' )
        pyautogui.scroll ( -280, x, y, _pause=1 )
        time.sleep(1)
