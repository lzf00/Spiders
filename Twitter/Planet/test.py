...
import pyautogui
key = 'UAM'
file_path = 'D:\All_Script\Python_planet_picture\\UAM/' + key + '1.csv'
...
time.sleep ( 2 )
driver.find_element_by_xpath ( '//input[@class="MuiInputBase-input"]' ).send_keys ( ''' 12° 40' 47.64" N,101° 0' 17.99" E ''' )
time.sleep ( 5 )
# 测试
...
for date in all_date:
    try:
        ...
        time.sleep ( 5 )
        print ( "11111" )#测试代码
        data = driver.find_element_by_xpath ('//div[@class="MuiButtonBase-root MuiListItem-root jss1496 MuiListItem-gutters MuiListItem-divider MuiListItem-button MuiListItem-secondaryAction Mui-selected jss1497"]/div[2]/div[1]/h6' )
        # 显示图片时间
        print ( "22222" )
        ...
        print ( text1 )
        pyautogui.screenshot( 'D:\All_Script\Python_planet_picture\\UTP/' + key + '_' + text1 + '.png' ,region=(850, 340, 476, 476))
        ...
        time.sleep ( 3 )
        pyautogui.screenshot( 'D:\All_Script\Python_planet_picture\\UTP/' + key + '_' + text1 +'_T'+ '.png' ,region=(485, 152, 1256, 890))
