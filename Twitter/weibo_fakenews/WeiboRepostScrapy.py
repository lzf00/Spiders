    ...
    try:
        ...
        while flag:
            ...
            if len(all_repost)==0:
                ...
                page = page + 1
                print("page:",page)
            elif exit_mark==False:
                exit_mark = True
                a = driver.find_element_by_xpath('//a[@class = "page prev S_txt1 S_line1"]')
                ActionChains(driver).move_to_element(a).click().perform()
                page = page - 1
                print("page:", page)
            else:
        ...
        print("url::::::::",url)
        # get_repost(wr, url, driver, q, user_q, mark)
        print('page:',page)
        pass
...
if __name__ =="__main__":
    ...
    # data = xlrd.open_workbook('fakenews21.xlsx')
    # i = 0
    # table = data.sheets()[0]
    # for word in range(1,table.nrows):
        # print('word',table.cell_value(word,3))
        #article_num = table.cell_value(word,3).split('/')[3]
        #print('article_num', article_num)
        # url = table.cell_value(word, 3).split('?')[0]+'?type=repost'
        #url = 'https://weibo.com/7069873217/IEPFBBsVv?type=repost'
        #file_path = 'D:\python_data\weibo/weibo_No_1122NN'+str(article_num)+'.csv'
